...
Report bugs at https://github.com/hunordori/netbox-av-plugin/issues.
...
NetBox AV Plugin could always use more documentation, whether as part of the
official NetBox AV Plugin docs, in docstrings, or even on the web in blog posts,
articles, and such.

### Submit Feedback

The best way to send feedback is to file an issue at https://github.com/hunordori/netbox-av-plugin/issues.
...
Ready to contribute? Here's how to set up `netbox-av-plugin` for local development.

1. Fork the `netbox-av-plugin` repo on GitHub.
2. Clone your fork locally

    ```
    $ git clone git@github.com:your_name_here/netbox-av-plugin.git
    ```
...
3. The pull request should work for Python 3.8, 3.9, 3.10 and 3.11. Check
   https://github.com/hunordori/netbox-av-plugin/actions
